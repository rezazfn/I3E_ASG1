...
* Author: Reza
* Date: 14/05/2024
* Description: Displays introduction when player is in starting collider
*/
...
{
    // Defines which is the introduction text in Unity Editor
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            // Activate introduction text to appear on screen
    ...
    void OnTriggerExit(Collider other)
    {
        ...
        if(other.gameObject.tag == "Player")
        {
            // Deactivate introduction text to not appear on screen
